...
| `GET`  | `/auth/posts/create`       | gets info to create or update a post                 |
| `POST` | `/auth/posts/create`       | creates a new post                                   |
| `PUT`  | `/auth/posts/update`       | update a previously created message                  |
| `DEL`  | `/auth/posts/delete`       | delete a post                                        |
...
| `DEL`  | `/auth/profile/delete`     | delete user profile (ADMIN role)                     |
...
| `DEL`  | `/auth/users/:user/remove` | remove selected user from friend list                |
